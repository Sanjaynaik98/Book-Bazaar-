		...
		<div class="row">
			<div class="col-md-4 offset-md-4">
				<div class="card">
					...
					<p style="color: green;" class="text-center">Registration Successfully</p>
						<form action="Register" method="post">
							...
							<button type="submit" class="btn btn-primary"><a href="registersuccess.jsp" style="text-decoration: none; color: white;">Submit</a></button>
						</form>
